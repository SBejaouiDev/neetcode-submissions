class Solution:
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        Then compare both and check what coordinates are both true in both the atlantic and pacific. 
        ...
        Run bfs on both pacific and atlantic queues. 
            ...
            - for each neighbor we check if its within the grid, has not been visited, and most importantly if the the neighboor is greater
